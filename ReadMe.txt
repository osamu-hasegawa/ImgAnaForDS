================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ImgAnaForDS プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ImgAnaForDS には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ImgAnaForDS アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ImgAnaForDS.h
   ...
   CImgAnaForDSApp アプリケーション クラスを宣言します。

ImgAnaForDS.cpp
   これは、アプリケーション クラス CImgAnaForDSApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ImgAnaForDS.ico
   ...
   アイコンはメイン リソース ファイル ImgAnaForDS.rc に含まれていま
   す。
...
ImgAnaForDSDoc.h, ImgAnaForDSDoc.cpp - ドキュメント
   これらのファイルは CImgAnaForDSDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CImgAnaForDSDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

ImgAnaForDSView.h, ImgAnaForDSView.cpp - ドキュメントのビュー
   これらのファイルは CImgAnaForDSView クラスを含みます。
   CImgAnaForDSView オブジェクトは CImgAnaForDSDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   ImgAnaForDS.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
